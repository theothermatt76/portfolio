...
####
#tagfix.pl: fix the CLOUD team's fork up. We need to remove a tag from each instance that does not have an ElasticIP
#matt brister <matt.brister@sterlingts.com>
